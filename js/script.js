...
x
    ...
    //         currentPage.textContent = `0${indexCurrentPage}`;
    //     } else {
    //         currentPage.textContent = indexCurrentPage;
    //     }
    ...
    //     allSlide[indexCurrentPage - 1].classList.remove('hide');
    //     allSlide[indexCurrentPage - 1].classList.add('show');
    // }

    // function nextPage() {
    //     ++indexCurrentPage;
    //     if (indexCurrentPage > allSlide.length){
    //         indexCurrentPage = 1;
    //     }
